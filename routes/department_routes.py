...
# Duplicate definition of get_room_schedules removed.
# The function was defined earlier in this file; keeping a single implementation prevents Flask endpoint collisions.
...
# Duplicate endpoint definitions were removed from this file to prevent Flask
# AssertionError: 'View function mapping is overwriting an existing endpoint'
# The original implementations are kept earlier in this module; any further
# changes should be applied to the single canonical implementation above.
